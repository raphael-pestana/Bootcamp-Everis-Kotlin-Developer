...
portanto ela quer que a execução de todos os casos de teste que ela selecionar (instâncias)
aconteçam no tempo máximo de um segundo, pois ela odeia esperar.
...
fun main(args: Array<String>) {
    ...
    for (i in 0 until n) {
        ...
        val prime = primeDetector(x)
        printPrime(prime)
    }
}

fun printPrime(prime: Boolean) {
    if (prime) {
        println("Prime")
    } else println("Not Prime")
}

fun primeDetector(num: Double): Boolean {
